...
module.exports = async () => {
  const prefixedDatabaseFile = process.env.SUBSCRIPTIONS_DATABASE_FILE || process.env.DATABASE_FILE
  const prefixedDatabaseName = process.env.SUBSCRIPTIONS_DATABASE || process.env.DATABASE
  let sequelize

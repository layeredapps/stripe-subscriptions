...
describe('/api/user/subscriptions/published-plan', function () {
  ...
  describe('exceptions', () => {
    ...
    describe('invalid-plan', () => {
      it('ineligible querystring plan is not published', async () => {
        ...
        const req = TestHelper.createRequest(`/api/user/subscriptions/published-plan?planid=${administrator.plan.planid}`)
  ...
  describe('returns', () => {
    it('object', async () => {
      ...
      assert.strictEqual(plan.planid, administrator.plan.planid)
    })
  })
})

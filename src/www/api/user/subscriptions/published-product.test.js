...
describe('/api/user/subscriptions/published-product', function () {
  ...
  describe('exceptions', () => {
    ...
    describe('invalid-product', () => {
      it('ineligible querystring product is not published', async () => {
        ...
        const req = TestHelper.createRequest(`/api/user/subscriptions/published-product?productid=${administrator.product.productid}`)

...
describe('/api/user/subscriptions/delete-subscription-item', function () {
  ...
  async function bundledData (retryNumber) {
    ...
    let req = TestHelper.createRequest('/api/user/subscriptions/delete-subscription-item')
    ...
    req = TestHelper.createRequest('/api/user/subscriptions/delete-subscription-item?subscriptionid=invalid')
    req.account = user.account
    req.session = user.session
    req.body = {
      itemid: user.subscription.stripeObject.items.data[0].id

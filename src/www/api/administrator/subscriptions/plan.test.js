...
describe('/api/administrator/subscriptions/plan', function () {
  ...
  describe('returns', () => {
    it('object', async () => {
      ...
      const req = TestHelper.createRequest(`/api/administrator/subscriptions/plan?planid=${administrator.plan.planid}`)
      req.account = administrator.account
      req.session = administrator.session

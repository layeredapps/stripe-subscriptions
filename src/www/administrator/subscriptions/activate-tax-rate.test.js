...
describe('/administrator/subscriptions/activate-tax-rate', function () {
  describe('before', () => {
  ...
  describe('submit', () => {
    it('should activate tax rate (screenshots)', async () => {
      ...
      req.screenshots = [
        ...
        { click: `/administrator/subscriptions/activate-tax-rate?taxrateid=${administrator.taxRate.taxrateid}` },
        { fill: '#submit-form' }
      ]
      global.pageSize = 50
  ...
  describe('errors', () => {
    it('invalid-taxrateid', async () => {
      const administrator = await TestHelper.createOwner()
      const req = TestHelper.createRequest('/administrator/subscriptions/activate-tax-rate?taxrateid=invalid')
      req.account = administrator.account
      req.session = administrator.session
      await req.route.api.before(req)
